...
const env: Environment = {
  ...
  mongo_db_name: process.env.MONGODB_DATABASE_NAME || "tiketa",
  mongo_user: process.env.MONGODB_USERNAME || "tiketaUser",
  mongo_password: process.env.MONGODB_PASSWORD || "Airikhion04",
